...
With that in mind I wanted to make something that generates one of these statistics that could technically be correct, just for the fun of it (and because language programming is interesting).
